...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Fields that can be updated in registrars table
    $fields = [
    ...
    // Build the SQL UPDATE query for registrars table
    $set_clause = [];
    $params = [];
    $types = '';
    $updates_made = false;
    ...
    if (!empty($set_clause)) {
        $sql = "UPDATE registrars SET " . implode(', ', $set_clause) . " WHERE user_id = ?";
        $params[] = $user_id;
