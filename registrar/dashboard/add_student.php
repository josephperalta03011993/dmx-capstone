...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["add_student"])) {
    ...
    $sql = "INSERT INTO students (first_name, last_name, middle_name, date_of_birth, gender, email, phone_number, address_line1, address_line2, city, state, zip_code, country, enrollment_date, parent_guardian_name, parent_guardian_phone, parent_guardian_email, emergency_contact_name, emergency_contact_phone) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "sssssssssssssssssss", $first_name, $last_name, $middle_name, $date_of_birth, $gender, $email, $phone_number, $address_line1, $address_line2, $city, $state, $zip_code, $country, $enrollment_date, $parent_guardian_name, $parent_guardian_phone, $parent_guardian_email, $emergency_contact_name, $emergency_contact_phone);
